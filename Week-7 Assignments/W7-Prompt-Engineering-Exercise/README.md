...
3. Implement your prompts inside `src/main/lab.py`, using whichever AI tool/model you have access to.

4. Run your script against all 5 sample messages and check the output.
