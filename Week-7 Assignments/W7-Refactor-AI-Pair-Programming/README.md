...
This assignment is designed to help you practice working alongside an AI pair-programming tool (e.g. GitHub Copilot) to improve real code, while staying responsible for reviewing and validating every suggestion it makes.
